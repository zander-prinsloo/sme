...
#' @export
get_ar1_tenure_full_likelihood_two_sigma_with_mu <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    g_1,
  ...
  #_____________________________________________________________________________
  # Computations ---------------------------------------------------------------
  lik <- get_ar1_tenure_individual_likelihood_two_sigma_with_mu(
...
#' lambda_g     = 2
#' )
get_ar1_tenure_individual_likelihood_two_sigma_with_mu <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    g_1,
  ...
  lik <- data.table::data.table(
    true_111 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_110 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_101 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_100 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_011 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_010 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_001 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_000 = get_ar1_tenure_joint_probability_two_sigma_with_mu(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
...
#' lambda_g     = 2
#' )
get_ar1_tenure_joint_probability_two_sigma_with_mu <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    st1_true,
