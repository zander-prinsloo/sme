...
#' @export
get_ar1_tenure_full_likelihood_mult_sigma <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    g_1,
  ...
  #_____________________________________________________________________________
  # Computations ---------------------------------------------------------------
  lik <- get_ar1_tenure_individual_likelihood_mult_sigma(
...
#' lambda_g     = 2
#' )
get_ar1_tenure_individual_likelihood_mult_sigma <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    g_1,
  ...
  lik <- data.table::data.table(
    true_111 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_110 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_101 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_100 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 1,
    ...
    true_011 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_010 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_001 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
    ...
    true_000 = get_ar1_tenure_joint_probability_mult_sigma(
      st1_observed = st1_observed,
      st2_observed = st2_observed,
      st3_observed = st3_observed,
      st1_true     = 0,
...
#' lambda_g     = 2
#' )
get_ar1_tenure_joint_probability_mult_sigma <- function(
    st1_observed,
    st2_observed,
    st3_observed,
    st1_true,
  ...
  p_tenure_q3 <-
    dnorm(
      x    = g_3 - g_1 - 0.5,
      mean = 0,
      sd   = sqrt(2*exp(sigma_g0 + sigma_g1*g_3)^2)
    ...
    ex_gaussian_density(
      x      = g_3,
      sigma  = exp(sigma_g0 + sigma_g1*g_3),
      lambda = lambda_g
  ...
  p_unempl_dur_q3 <-
    dnorm(
      x    = h_3 - h_1 - 0.5,
      mean = 0,
      sd   = sqrt(2 * exp(sigma_h0 + sigma_h1*h_3)^2)
    ...
    ex_gaussian_density(
      x      = h_3,
      sigma  = exp(sigma_h0 + sigma_h1*h_3),
      lambda = lambda_h
