...
#' @return list
#' @export
estimate_ar1_tenure_mult_sigma <- function(
    st3_observed         = NULL,
    st2_observed         = NULL,
    st1_observed         = NULL,
    gt3                  = NULL,
  ...
  if (isTRUE(global_est)) {
    ...
    if (is.null(global_specification)) {
      ...
      sigma_g_upper    <- global_specification$sigma_g_upper
      sigma_g_lower    <- global_specification$sigma_g_lower
      sigma_h_upper    <- global_specification$sigma_h_upper
      sigma_h_lower    <- global_specification$sigma_h_lower
    ...
    par_space <- makeParamSet(
      ...
      makeNumericParam(
        "sigma_g0",
        lower = sigma_g0_lower,
        upper = sigma_g0_upper
      ),
      makeNumericParam(
        "sigma_g1",
        lower = sigma_g1_lower,
        upper = sigma_g1_upper
      ),
      makeNumericParam(
        "sigma_h0",
        lower = sigma_h0_lower,
        upper = sigma_h0_upper
      ),
      makeNumericParam(
        "sigma_h1",
        lower = sigma_h1_lower,
        upper = sigma_h1_upper
      ),
      makeNumericParam(
        "lambda_g",
